...
const FilterSearch = ({textInfo}: {textInfo?: string}) => {
  return (
    <div className={`flex justify-between items-center gap-2 px-1 py-1 text-white text-8 bg-gray-600/50 bg-opacity-50 shadow-sm border-t-2 border-white mt-8 ${textInfo ? textInfo : ' md:gap-4 lg:gap-6 md:text-xl md:max-w-2xl md:mx-auto rounded-4xl md:py-2 md:pl-6 md:pr-2'}`}>
